...
/// </summary>
public class Music_Title_and_LvlSelect : MonoBehaviour
{
    [Tooltip("Names of the scenes this object should stay alive in when transitioning into")]
    public List<string> sceneNames = new List<string>() { "Menu", "LevelSelect" };
    ...
    void CheckForDuplicateInstances()
    {
        ...
        Music_Title_and_LvlSelect[] collection = FindObjectsOfType<Music_Title_and_LvlSelect>();

        // iterate through the objects with this component, deleting those with matching identifiers
        foreach (Music_Title_and_LvlSelect obj in collection)
        {
